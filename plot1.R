...
# Aggregation of PM2.5 emission to get total PM2.5 emission 
# from all sources for each of the years 1999, 2002, 2005, and 2008.

TotAggPM <- aggregate(Emissions ~ year,NEI, sum)

## Code for construction plot1

png(filename='plot1.png') # save png

barplot(
  (TotAggPM$Emissions)/10^6, #to make data in y-axis more understandable
  names.arg = TotAggPM$year,
  xlab="Year",
  ylab="PM2.5 Pollutant Emission (10^6 Tons)",
